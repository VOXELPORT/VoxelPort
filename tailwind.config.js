  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        "card-hover":   "0 8px 36px rgba(0,0,0,0.65), 0 2px 8px rgba(0,0,0,0.4)",
      ...
      animation: {
        ...
        "glow-breathe":   "glowBreathe 2.8s ease-in-out infinite",
        "slide-right":    "slideRight 0.2s ease-out",
        "status-ping":    "statusPing 1.8s ease-out infinite",
      },
      keyframes: {
        ...
        glowBreathe: {
          "0%,100%": { boxShadow: "0 0 0 1px rgba(74,222,128,0.2),  0 0 18px rgba(74,222,128,0.08), 0 4px 24px rgba(0,0,0,0.55)" },
          "50%":     { boxShadow: "0 0 0 1px rgba(74,222,128,0.38), 0 0 32px rgba(74,222,128,0.18), 0 4px 24px rgba(0,0,0,0.55)" },
        },
